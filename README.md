...
- Sequence modeling and LLM architectures (Mamba, S4, Transformers)
- End-to-end ML pipelines: from feature engineering to production deployment
- Generative AI and applied NLP
- Probabilistic modeling and unsupervised learning
- MLOps: experiment tracking, containerization, and API deployment
...
**[Cell Fate Prediction via Topic Modeling on scRNA-seq](https://github.com/vaibhav3000/cell-fate-prediction)** `Jan 2026 - Apr 2026`

Built a Poisson NMF and LDA pipeline on 11,000+ single cells, with a supervised classification layer for early fate prediction.
